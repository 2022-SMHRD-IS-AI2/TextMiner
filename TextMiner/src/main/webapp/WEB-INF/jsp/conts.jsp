...
<%--  <%	
 for(int i = 0; i< dto.size() ;i++) {
 	BoardDTO dtodto = dto.get(i);
		...
		String b_keyword = dtodto.getB_keyword();
		String b_title = dtodto.getB_title();
		String b_or = dtodto.getB_or();
		String b_sor = dtodto.getB_sor();
		String b_conts = dtodto.getB_conts();
		String b_region = dtodto.getB_region();
		String b_url = dtodto.getB_url();
		Date b_sdate = dtodto.getB_sdate();
		Date e_sdate = dtodto.getB_edate();
%> --%>
    <div id="wrap">
        <header class="header">
